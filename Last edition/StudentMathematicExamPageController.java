...
public class StudentMathematicExamPageController implements Initializable {
   ...
   // save the btn  answer in db;} 
    @FXML
    private void option1RadioButtonHandler(ActionEvent event) {
    ...
    @FXML
    private void option2RadioButtonHandler(ActionEvent event) {
    ...
    @FXML
    private void option3RadioButtonHandler(ActionEvent event) {
    ...
    @FXML
    private void option4RadioButtonHandler(ActionEvent event) {

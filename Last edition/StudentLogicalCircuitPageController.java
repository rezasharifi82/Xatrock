...
public class StudentLogicalCircuitPageController implements Initializable {
    ...
    @FXML
       ...
       Parent root = FXMLLoader.load(getClass().getResource("MessengerPage.fxml"));
        ...
        Parent root = FXMLLoader.load(getClass().getResource("StudentLogicalCircuitExamPage.fxml"));
        stage = (Stage)((Node)e.getSource()).getScene().getWindow();
        scene = new Scene(root);
        stage.setScene(scene);
        stage.show();

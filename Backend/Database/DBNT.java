...
public class DBNT {
    ...
    public static List<Exam> get_list_member_exam(int memberid){
    ...
    public static List<Lesson_Page> get_chat_text(String name){return Question_Source.get_chats(name);}
    public static void get_chat_pdf(String name){PDFGT.chatexport(name);}
    public static void get_chat_pdf(List<String> messages,String lesson){PDFGT.chatexport(messages,lesson);}
    public static int you_have_it(int id,String name_of_lesson){
        List<Lesson>me =get_member_lesson(id);
        for (Lesson i : me) {
            if (i.getLessoname().equals(name_of_lesson)) {
                return 1;
            }
            }
        return -1;
...
//        i.add(4);
       ...
       // import_by_excel("/home/rezash/Desktop/Final/Finall/src/main/java/xat/DataBase/myfile.xlsx");
//    import_by_excel("sad");
//    forget_Password("asd","ad");
//    get_list_member_exam(5);
       ...
       // System.out.println(Member_source.find_by_id(3));
            new_Member("Subasa","suba@japan.com",0,0,"09155078545","12345678","Student","Ozara");
        //get_chat_pdf("Ap");
